...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // This will make the hamburger icon animate
//        drawerLayout.setDrawerListener(drawerToggle);

//        navigationView.getMenu().getItem(0).setChecked(true);
//        navigationView.getMenu().performIdentifierAction(R.id.custom_id, 0);
        navigationView.setCheckedItem(R.id.menu_south_park);
    ...
    public void selectDrawerItem(MenuItem menuItem) {
        ...
        if (fragmentClass == null) {
            Toast.makeText(this, "Unknown fragment class", Toast.LENGTH_SHORT).show();
            return;
        }
